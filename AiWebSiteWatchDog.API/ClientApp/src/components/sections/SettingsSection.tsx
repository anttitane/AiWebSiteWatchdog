    ...
    <section className="card">
      ...
      <div className={"space-y-4 text-sm " + (editing ? '' : 'pointer-events-none')}> {/* keep interactive only when editing */}
          <label className={"text-sm flex flex-col relative " + (changed.userEmail ? 'after:absolute after:-right-2 after:top-2 after:w-2 after:h-2 after:rounded-full after:bg-amber-400' : '')}>
            ...
            <input
              className={"modal-input " + (!editing ? 'bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700' : '') + (changed.userEmail ? ' ring-2 ring-amber-300 dark:ring-amber-500' : '')}
              type="email"
          ...
          <label className={"text-sm flex flex-col relative " + (changed.senderEmail ? 'after:absolute after:-right-2 after:top-2 after:w-2 after:h-2 after:rounded-full after:bg-amber-400' : '')}>
            ...
            <input
              className={"modal-input " + (!editing ? 'bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700' : '') + (changed.senderEmail ? ' ring-2 ring-amber-300 dark:ring-amber-500' : '')}
              type="email"
          ...
          <label className={"text-sm flex flex-col relative " + (changed.senderName ? 'after:absolute after:-right-2 after:top-2 after:w-2 after:h-2 after:rounded-full after:bg-amber-400' : '')}>
            ...
            <input
              className={"modal-input " + (!editing ? 'bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700' : '') + (changed.senderName ? ' ring-2 ring-amber-300 dark:ring-amber-500' : '')}
              type="text"
          ...
          <label className={"text-sm flex flex-col relative " + (changed.geminiApiUrl ? 'after:absolute after:-right-2 after:top-2 after:w-2 after:h-2 after:rounded-full after:bg-amber-400' : '')}>
            ...
            <input
              className={"modal-input font-mono text-xs " + (!editing ? 'bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700' : '') + (changed.geminiApiUrl ? ' ring-2 ring-amber-300 dark:ring-amber-500' : '')}
              type="url"
